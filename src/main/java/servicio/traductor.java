...
public class traductor {
    ...
    public static void traducir(model mod) throws Exception {
        GT g = new GT();
        String txt= mod.getTexto();
        mod.setTextIn(g.translateText(txt, "auto", "en"));
    }

    public static void main(String args[]) throws Exception {
        System.out.println("-----test-----");
        String txt = "hola, mi nombre es edgard, estudio en valle grande";
        GT g = new GT();
        System.out.println(g.translateText(txt, "auto", "en"));
        System.out.println(g.translateText("Quién puede decir que el soporte no es compatible", "auto", "en"));
    }
    ...
    public static class GT {
        ...
        /**
         * Inicializar la clase de idioma
         */
        private void init() {
        ...
        /**
         * Determinar si el idioma admite
         *
         * @param language
         * @return
         */
        ...
        /**
         * Obtener el código de idioma ISO 639-1 code
         *
         * @param deseado Idioma idioma
         * @
         * return Si devuelve nulo , indica que no es compatible
         *
         */
         ...
         * Texto traducido
         *
         * @param texto contenido de texto
         * @param sourceLang El idioma del texto. Si no lo sabe, puede usar auto
         * @param targetLang idioma de destino. Debe ser un idioma de destino
         * claro y eficaz
         * @return
         * @throws Exception
         */
        public String translateText(String text, String sourceLang, String targetLang) throws Exception {
            ...
            if (!(isSupport(sourceLang) || isSupport(targetLang))) {
                System.out.println("Tipo de idioma no admitido");
            }
